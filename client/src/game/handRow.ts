...
// Шаг подобран так, чтобы рука читалась как ПЛОТНАЯ пачка, а не как разложенный ряд:
// торцы видно и их можно сосчитать, но карты лежат тесно-тесно, номиналы не прочитать.
const MAX_STEP = 0.06; // предпочтительный шаг, в ширинах карты — очень тесно
