...
export class GameState extends Schema {
  ...
  // Где именно у держателя: "hand" (рука — там колода раскрывается веером) или "safe"
  // (сейф — там карты всегда рубашкой вверх). Пусто, пока колода на общем столе.
  // Места внутри сейфа не нумеруются: колоды раскладываются там сами.
