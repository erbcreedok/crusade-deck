...
export class GameState extends Schema {
  ...
  // Где именно у держателя: "hand" (рука — там колода раскрывается веером) или
  // "pocket0".."pocket2" (слот кармана — там карты всегда рубашкой вверх). Пусто, пока
  // колода на общем столе. Слот важен: в карман влезает до трёх отдельных колод.
  @type("string") deckSlot: string = "";
