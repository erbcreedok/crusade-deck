...
Порт 2567 наружу **не открывать**. Colyseus слушает `0.0.0.0`, поэтому от внешнего
мира его закрывает именно UFW — без файрвола сервер будет доступен напрямую по IP
в обход TLS.
